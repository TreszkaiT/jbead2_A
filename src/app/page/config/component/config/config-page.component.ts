...
export class ConfigPageComponent {
  ...
  public btn1Handler() {                                                      // ha a HTML-ben a btn1-re kattintanak, akkor Effects-et, Service-t és DB-t is használunk
      this.configStoreService.dispatchGetEntityAction('test');                // akkor a configStoreService lefut, és el-dispatchel egy GetEntityAction-t. GetEntityAction feladata: a hozzá társított Effect-ben kimegyünk, és a DataService által lekérünk egy Action-t 
  }
  ...
  public btn2Handler() {
      this.configStoreService.dispatchUpdateEntityAction({                    // itt eldobunk egy Action-t egy paraméterrel, de nincs Effect, Service, DB, csak direktbe bemódosítjuk a Storet
          id: 'test',                                                         // hogy a Store-ban közvetlen ezt a konfigot állítsuk be
